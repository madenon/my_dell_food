  ...
  return (
    <form onSubmit={placeOrder} className="place-order">
      <div className="place-order-left">
        ...
        <p className="autre">Si vous voulez payer  à la livraison prière<br/>
           de cliquer d'abord sur autre moyen de payement avant de remplir les champs en bas à droit </p>
      ...
      <div className="place-order-right">
        <div className="cart-total">
          ...
          <button type="submit">Payer par Stripe</button>
          <button type="submit"><Link to="/autre">Autre Methode de payment</Link></button>
